...
::============================================================================
::
::   IDM Activation Script (IAS)​ - Custom By DaCoding
::
::============================================================================
...
:: Prompt the user for their first name (fname)
set /p fname="Enter First Name (just hit Enter for random): "
if "%fname%"=="" (
    set /a fname=%random% %% 9999 + 1000
    echo Using random first name: %fname%
)

:: Prompt the user for their last name (lname)
set /p lname="Enter Last Name (just hit Enter for random): "
if "%lname%"=="" (
    set /a lname=%random% %% 9999 + 1000
    echo Using random last name: %lname%
)

:: Set the email address using the entered or random values
